...
for (i = 0; i < g_links.length; i++) { 
  ...
  graph.addNode( g_links[i][0], {ctg: g_node_to_ctg[g_links[i][0]] })
  graph.addNode( g_links[i][2], {ctg: g_node_to_ctg[g_links[i][2]] })
  graph.addLink( g_links[i][0], g_links[i][2], {color:g_links[i][3], ctg:g_links[i][4]} ); 
}
